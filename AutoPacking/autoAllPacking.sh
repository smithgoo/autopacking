...
#echo "\033[33;1m1. VideoProject \033[0m"
#
#read parameter
#sleep ${__SLEEP_TIME}
...
#read parameter
#sleep ${__SLEEP_TIME}
__IS_AUTO_OPENT_FILE_SELECTED="1"
...
# ===============================自动打包部分=============================
echo -n -e  "\033[33m请输入渠道标识逗号隔开 chn:\033[0m"
read chn
arr=(${chn//,/ })
...
#设置渠道包的名称
/usr/libexec/PlistBuddy -c "Set chn $s" ${__CURRENT_INFO_PLIST_PATH}
